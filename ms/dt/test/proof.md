...
* `class` : text
	...
	Value of the theoremâ€™s class attribute which can be used to add custom CSS or JavaScript.
* `nonumber` : flag (empty)
...
* `class` : text
	...
	Value of the remarkâ€™s class attribute which can be used to add custom CSS or JavaScript.
* `nonumber` : flag (empty)
